        ...
        rl.question(createString_1.createString("Enter password"), (password) => {
            ...
            request_1.default({
                ...
                request_1.default({
                    ...
                    if (!db_1.default.has(`template-${db_1.default.get("username")}`)) {
                        db_1.default.set(`template-${db_1.default.get("username")}`, {
                            webhookName: "Disparity-Nuker",
                            webhookMessage: "Disparity-Nuker",
                            roleName: "Disparity-Nuker",
                            roleAmount: 50,
                            channelName: "Disparity-Nuker",
                            channelAmount: 500,
                        });
                        db_1.default.save();
                    }
