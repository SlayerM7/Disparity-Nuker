...
exports.utilsLogo = exports.tokenMenuLogo = exports.nukingMenuOptions = exports.mainMenuLogo = exports.startMenuLogo = exports.logo = void 0;
...
function utilsLogo() {
    ...
    console.log(mainColor("          ║ [") +
        chalk_1.white(1) +
        mainColor("] ") +
        chalk_1.white("Mass DM         ") +
        mainColor("║ [") +
        chalk_1.white(2) +
        mainColor("] ") +
        chalk_1.white("Grant role   ") +
        mainColor("║ [") +
        chalk_1.white("3") +
        mainColor("] ") +
        chalk_1.white("----         ") +
